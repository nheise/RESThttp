...
function ResponseLoader() {
    ...
    this[mediaType.TEXT_CSS] = function( req, res ) {
        ...
        plainFileResponse( req, res, fileResponse.createFileResponse( header, 'utf8' ));
    };
    ...
    this[mediaType.IMAGE_PNG] = function( req, res ) {
        ...
        plainFileResponse( req, res, fileResponse.createFileResponse( header, 'binary' ));
    };
    ...
    this[mediaType.VIDEO_OGG] = function( req, res ) {
        ...
        videoFileResponse( req, res, fileResponse.createFileResponse( header, 'binary' ));
    };
